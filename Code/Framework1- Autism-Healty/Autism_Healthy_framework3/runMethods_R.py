...
csvfile= 'Autism_R_10ROI_Autism_vs_Healthy.csv'
...
if first10 == 1:
	mRMR_indices = [ 0,3,2,8,4,1,258,65,9, 5,6,264,34,79,155,149,10,145,15,138,136,33,130,106,259,16,256,216,17 ,128,151, 66,  247,224,146,127,257,162,207,20 , 80,147,22,137,64 , 26,225,95 ,205, 14]
...
train = train[1: , 1:] #<-change this line according to csv file
train= unique(train)
...
filename_train = 'train_RESULTS_'+ csvfile + '.csv'
filename_test = 'test_RESULTS_' + csvfile + '.csv'
np.savetxt(filename_train, train_arr,  delimiter=",")
